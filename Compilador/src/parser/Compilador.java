...
//Gramatica de expressoes:
  static final public 
Expressao iniciaExpressao() throws ParseException {Expressao exp = new Expressao();
    expressao(exp);
exp.otimizarPosFixaConst1();
  ...
  static final public void expressao(Expressao exp) throws ParseException {Token t ;
        Item item = null;
    termo(exp);
    label_1:
    while (true) {
...
exp.addListaExpPosFixa(item);
  ...
  static final public void termo(Expressao exp) throws ParseException {Token t;
        Item item = null;
    termo1(exp);
    label_2:
    while (true) {
...
exp.addListaExpPosFixa(item);
  ...
  static final public void termo1(Expressao exp) throws ParseException {Token t;
        Item item = null;
...
item = new Operador(operador,t);
  ...
  static final public void termo2(Expressao exp) throws ParseException {Token t;
        Item item = null;
    termo3(exp);
    label_3:
    while (true) {
...
item = new Operador(TipoOperador.CONCAT,t);
  ...
  static final public void termo3(Expressao exp) throws ParseException {Token t;
        TipoOperador operador;
        Item item = null;
    termo4(exp);
    label_4:
...
item = new Operador(operador,t);
  ...
  static final public void termo4(Expressao exp) throws ParseException {Token t;
        TipoOperador operador;
        Item item = null;
    pot(exp);
    label_5:
...
item = new Operador(operador,t);
  ...
  static final public void pot(Expressao exp) throws ParseException {Token t;
        TipoOperador operador;
        Item item = null;
    termo5(exp);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
item = new Operador(operador, t);
  ...
  static final public void termo5(Expressao exp) throws ParseException {Token tokenVar, tokenEntrada;
        Item item = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case AP:{
...
//GRAMATICA COMPLETA
  static final public 
void inicio(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {
  ...
  static final public void atribuicao(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token atrib, var;
...
AcoesSemanticas.incompatibilidadeTipoAtribuicao (tabela.pesquisaTabela(var.image), expressao, var);
  ...
  static final public void declaracao(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token atrib, variavel;
        TipoDado tipo = null;
        ComandoAltoNivel comando = null;
        Expressao expressao = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
//Inclusão do senao(else) como opcional apos a leitura da listaProgramaSe
  static final public void se(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token se,senao;
...
listaComandosAltoNivel.addComando(comando);
  ...
  static final public void enquanto(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token enq;
...
comando = new ComandoEnquanto(expressao, listaProgramaEnquanto, enq);
  ...
  static final public void le(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token le, t;
...
comando = new ComandoEntrada(tabela.pesquisaTabela(t.image), le);
  ...
  static final public void exibe(ListaComandosAltoNivel listaExibe) throws ParseException {Token exibe;
        Expressao expressao = null;
...
comando = new ComandoSaida(expressao, exibe);
  ...
  static final public void para(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token tokenPara;
...
comando = new ComandoPara(listaAtribuicaoInicio, expressao, listaAtribuicaoPasso, listaProgramaPara, tokenPara);
  ...
  static final public void seletor(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token tokenSeletor, tokenEntrada;
        Item itemCaso = null;
...
comando = new ComandoSeletor(expressaoSeletor, listaComandosAltoNivelCasos, listaOpcaoCasos, token);
  ...
  static final public void repeat(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token tokenRepeat, tokenNumero;
...
comando = new ComandoRepeat(listaProgramaRepeat, tokenRepeat, item);
  ...
  static final public void seRepete(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token se_repete, token_repete_n;
        Expressao exp = null;
        Item item;
...
comando = new ComandoSeRepete(exp, token_repete_n, item, lista_escopo_SeRepete);
  ...
  static final public void duplo(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {Token tokenDuplo;
...
comando = new ComandoDuplo(listaProgramaDuplo, tokenDuplo);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0xc0000000,0x1aa2a700,0x1aa2a700,0x18000000,0x0,0x0,0x0,0x800,0x0,0x0,0xc0000000,0x80000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x10,0x20,0x680,0x680,0x100,0x1,0x1,0x6,0x6,0x8,0x181001,0x100000,0x100000,0x0,0x40,0x40000,0x40,0x0,0x40000,0x40000,0x1,0x0,};
   }
